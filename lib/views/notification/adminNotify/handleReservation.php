        ...
        <div class="row no-print mb-3">
            <div class="col-3">
                <div class="input-group">
                    <input type="date" class="form-control" id="searchValue" placeholder="Search by Date">
...
<script>
    $(document).ready(function() {
        ...
        function fetch_data(page) {
            $.ajax({
                url: "../routes/notification/admin/viewReservation.php",
                method: "POST",
                data: {
                    page: page
                },
        ...
        function load_data(page, key = "") {
            $.ajax({
                url: "../routes/notification/admin/searchReservation.php",
                method: "POST",
                data: {
                    page: page,
                    key: key
        ...
        $(document).on("click", ".conBtn", function() {
            var id = $(this).attr("id");
            $(this).removeClass("btn-outline-primary").addClass("btn-success").text("Confirmed");
            $.ajax({
                url: "../routes/notification/admin/confirmReservation.php",
                method: "POST",
                data: {
                    id: id
                },
