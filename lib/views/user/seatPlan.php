<div class="row">
    ...
    <div id="cardDetails" class="col-md-9">
                    ...
                    <div class="col-md-10">
                        <div>
                            <div class="row mt-2">
                                ...
                                <div class="seat counter" id="5" style="background-color: #ffc266 ;pointer-events: none">
                                    <h6>05</h6>
                                </div>
                                ...
                                <div class="seat available" id="54">
                                    <h6>54</h6>
                                </div>
                            </div>
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="seat counter" id="4" style="background-color: #ffc266 ;pointer-events: none">
                                    <h6>04</h6>
                                </div>
                                ...
                                <div class="seat available" id="53">
                                    <h6>53</h6>
                                </div>
                            </div>
                            ...
                            <div class="row mt-2">
                                <div class="seatN available"></div>
                                <div class="seat counter" id="3" style="background-color: #ffc266 ;pointer-events: none">
                                    <h6>03</h6>
                                </div>
                                ...
                                <div class="seat available" id="52">
                                    <h6>52</h6>
                                </div>
                            </div>
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="seatN available"></div>
                                <div class="seatN available"></div>
                                <div class="seat available" id="51">
                                    <h6>51</h6>
                                </div>
                            </div>
                            ...
                            <div class="row mt-2">
                                <div class="seatN available"></div>
                                <div class="seat counter" id="2" style="background-color: #ffc266 ;pointer-events: none">
                                    <h6>02</h6>
                                </div>
                                <div class="seat counter" id="7" style="background-color: #ffc266 ;pointer-events: none">
                                    <h6>07</h6>
                                </div>
                            ...
                            <div class="row mt-2">
                                <div class="seatN available"></div>
                                <div class="seat counter" id="1" style="background-color: #ffc266 ;pointer-events: none">
                                    <h6>01</h6>
                                </div>
                                <div class="seat counter" id="6" style="background-color: #ffc266 ;pointer-events: none">
                                    <h6>06</h6>
                                </div>
