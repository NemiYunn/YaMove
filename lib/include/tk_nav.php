...
<div class="vertical-nav bg-white no-print" id="sidebar">
   <div class="py-4 px-3 mb-4 bg-light">
     <div class="media d-flex align-items-center">
       ...
       <div class="media-body">
         ...
         <p class="font-weight-normal text-muted mb-0">Tool Keeper</p>
       </div>
     </div>
   </div>
   ...
   <ul class="nav flex-column bg-white mb-0">
     <li class="nav-item ">
       <a href="../views/toolkeeper.php" class="nav-link text-dark bg-light">
...
<!-- 
     ...
     <li class="nav-item">
       <a href="#" class="nav-link text-dark" id="task">
     ...
     <li class="nav-item">
       <a href="#" class="nav-link text-dark" id="report">
       <i class="fa fa-tasks " aria-hidden="true"></i>
         Reports 
       </a>
     </li>
