...
<div class="page-content p-5 " id="content">
  <!-- Toggle button -->
  <button id="sidebarCollapse" type="button" class="btn btn-light bg-white rounded-pill shadow-sm px-4 mb-4 no-print"><i class="fa fa-bars mr-2 no-print"></i><small class="text-uppercase font-weight-bold no-print">Toggle</small></button>
